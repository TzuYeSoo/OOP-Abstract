...
public class Birth_Storage extends Birth {
   ...
   public String getFileName(){
    ...
    public void BStore(){
        ...
        BStore.put("1A" + Navigation + getName() , getFname());
        BStore.put("2A" + Navigation + getName() , getMname());
        BStore.put("3A" + Navigation + getName() , getLname());
        BStore.put("4A" + Navigation + getName() ,  getsuff());
