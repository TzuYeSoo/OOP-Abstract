...
//Loops Boolean	    
	    ...
	    static String Cont, PDName, Price, Copy, Amount, Address, SignOut = "1";
		        	...
		        	do {
		              ...
		              System.out.printf("\t\t\t============================================================================================================================="
		               ...
		               case "F":
		            	   ...
		            	   case "B":
                                           BFill = String.valueOf(BCode_Num);
		            		   Birth();
		            	   ...
		            	   case "M":
		                       ...
		                       System.out.println("\n\t\t\t=============================================================================================================================\n");
                                       System.out.println("\n\t\t\t\t\t\t\t\t\t\tDo you have A Cenomar Certificate"
                                               + "\n\t\t\t\t\t\t\t\t\t\t[Y] Yes"
                                               + "\n\t\t\t\t\t\t\t\t\t\t[N] No"
                                               + "\n\t\t\t\t\t\t\t\t\t\tYour Input: ");
                                       String CenoVer = scn.next().toUpperCase();
		                       System.out.println("\t\t\t=============================================================================================================================");
                                       if(CenoVer.equals("Y")){
                                           System.out.println("\n\t\t\t\tEnter the code of your cenomar Cert: ");
                                           CFill = scn.next();
                                           
                                           if(Cenomar_Code.containsKey(CFill)){
                                               System.out.println("\t\t\t\tFor Verification Only, Please Answer The questions!!!");
                                               System.out.println("\t\t\t\tEnter the Name of the Wife same as the Cenomar Certificate:");
                                               scn.nextLine();
                                               String CenoName = scn.nextLine();
                                               System.out.println("\t\t\t\tEnter the Name of the Husband same as the Cenomar Certificate: ");
                                               scn.nextLine();
                                               String CenoHName =scn.nextLine();
                                               
                                               if(Cenomar_Storage.containsValue(CenoName) && Cenomar_Storage.containsValue(CenoHName)){
                                                ...
                                                MCode_Num++; 
                                                   ...
                                                   System.out.println("Not the Same Value as the Cenomar Certificate Request Denied!!!");
                                               }
	...
	public static void Birth_Storage() {
		...
		BStore.put("1A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey() , B.getFname());
	        BStore.put("2A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey() , B.getMname());
	        BStore.put("3A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey() , B.getLname());
	        BStore.put("4A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey() ,  B.getsuff());
	        BStore.put("6A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey() , B.getBD());
	        BStore.put("7A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey() , B.getHos());
	        BStore.put("5A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey() , B.getgen());
	        BStore.put("8A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey() , B.getprovi());
	        BStore.put("9A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getCity());
	        BStore.put("10A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getHos());
	        BStore.put("11A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getTB());
	        BStore.put("12A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getTBP());
	        BStore.put("13A" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getweigh());
	        
	        BStore.put("1M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getMFname());
	        BStore.put("2M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getMMname());
	        BStore.put("3M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getMLname());
	        BStore.put("4M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getMCite());
	        BStore.put("5M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getReligion());
	        BStore.put("6M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getMocc());
	        BStore.put("7M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getMage());
	        BStore.put("8M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getMHos());
	        BStore.put("9M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getMCity());
	        BStore.put("10M" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getMprovi());
	        
	        BStore.put("1F" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getFFname());
	        BStore.put("2F" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getFMname());
	        BStore.put("3F" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getFLname());
	        BStore.put("4F" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getFCiten());
	        BStore.put("5F" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getFReligion());
	        BStore.put("6F" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getFocc());
	        BStore.put("7F" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getFage());
	        BStore.put("8F" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getFHos());
	        BStore.put("9F" + BFill.substring(BFill.length()-1) +B.getBirthStoreKey(), B.getFCity());
	        BStore.put("10F" + BFill.substring(BFill.length()-1) + B.getBirthStoreKey(), B.getFprovi());
...
System.out.println("\t\t\t========================================================================================================================");
	...
	public static void Birth_Semi_Admin() throws InterruptedException, IOException{
            ...
            String BCODE = scn.next().toUpperCase();
        ...
        public static void Birth_Admin_Add() throws IOException, InterruptedException{
                                Birth();
                                BFill = String.valueOf(BCode_Num);
                                BirthNavi = BFill.substring(BCode_Num);
                                B.setBirthStoreKey(B.getFname() + " " + B.getMname() + " " + B.getLname());
                                Birth_Storage();
                                do{
        ...
        public static void Cenomar_Admin() throws InterruptedException{
            switch(AdminPurp){
                ...
                case "D":
                    ...
                    break;
                case "E":
                    System.out.println("This Certificate Cannot be edit Sorry!!");
                    break;
                case"S":
                    SignOut();
                    if(SignOut.equals("N")){
    ...
    // Start of Marraige
        ...
        boolean birthchecker = true;
        while(birthchecker){
        System.out.print("\t\t\t\t2.Date of Birth (MM/DD/YYYY): ");
        String dateofbirth = scanner.nextLine();
        ...
        System.out.print("\t\t\t\t4.Place of Birth (City, Province): ");
        ...
        System.out.print("\t\t\t\t9.Civil status: ");
        String status = scanner.nextLine();
        Marriage.setWifeStatus(status);

        System.out.print("\t\t\t\t10.Full name of Father: ");
        String father = scanner.nextLine();
        Marriage.setWifeFather(father);

        System.out.print( "\t\t\t\t11.Citizenship of Father: ");
        String fatherCitizen = scanner.nextLine();
        Marriage.setWifeFatherCitizen(fatherCitizen);

        System.out.print("\t\t\t\t12.Full name of Mother: ");
        String motherName = scanner.nextLine();
        Marriage.setWifeMother(motherName);

        System.out.print("\t\t\t\t13.Citizenship of Mother: ");
        ...
        System.out.print("\t\t\t\t14c.Last Name: ");
        ...
        while(Husbandchcker){
        System.out.print("\t\t\t\t15.Date of Birth (MM/DD/YYYY): ");
        String hdateofbirth = scanner.nextLine();
        if(!hdateofbirth.matches("\\d{2}/\\d{2}/\\d{4}")){
            System.out.println("\t\t\t\tInvalid Input!");
            Husbandchcker = true;
        ...
        System.out.print("\t\t\t\t17.Place of Birth (City, Province): ");
        String hprovince = scanner.nextLine();
        Marriage.setHusbandPlaceOfBirth(hprovince);
        //Husband Checker
        boolean husbandChcker = true;
        while(husbandChcker){
        System.out.print("\t\t\t\t18.Sex(f/m): ");
        ...
        do{
            System.out.println("\n\t\t\t=============================================================================================================================");    
            System.out.print("\t\t\t\t\t\t\t\t\t\tDo you want to continue or edit?"
                        + "\n\t\t\t\t\t\t\t\t\t\t[C] Continue"
                        + "\n\t\t\t\t\t\t\t\t\t\t[E] Edit"
                        + "\n\t\t\t\t\t\t\t\t\t\tYour Input: ");
                CE = scn.next().toUpperCase();
             ...
             System.out.print("\t\t\t\t\tEnter the Code Number That have been given to you after your Fill Up Form: ");
                                   ...
                                   if(Marriage_Code.containsKey(MFill)){
                                       ...
                                       if(Marriage_MCode.get(MFill) == "Done"){
                                           ...
                                           System.out.print("\n\t\t\t\t\t\t\t\t\tThis Certificate have been Already approve and certificate is ready"
                                                   + "\n\t\t\t\t\t\t\t\t\t\tIf you want another copy press N, if no press X"
                                                   + "\n\t\t\t\t\t\t\t\t\t\t[N] New Coppy"
                                                   + "\n\t\t\t\t\t\t\t\t\t\t[X] Exit: ");
                                           String NCopy = scn.next().toUpperCase(); 
  ...
  public static void SignOut(){
      System.out.println("Do you want to signout?"
              + "[Y]Yes"
              + "[N]No"
              + "Your Input: ");
              SignOut = scn.next().toUpperCase();
  }
}
