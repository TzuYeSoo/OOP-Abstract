		        	...
		        	do {
		               ...
		               case "F":
		            	   ...
		            	   case "M":
                                       ...
                                       System.out.println("Do you have A Cenomar Certificate"
                                               + "\n[Y] Yes"
                                               + "\n[N] No");
                                       String CenoVer = scn.nextLine().toUpperCase();
                                       
                                       if(CenoVer.equals("Y")){
                                           System.out.println("Enter the code of your cenomar Cert: ");
                                           CFill = scn.next();
             ...
             System.out.print("Enter the code you want to view: ");
                                ...
                                if(Cenomar_Code.containsKey(CFill)){
                                    ...
                                    if(CE.equals("Y")){
                                        ...
                                        if(Cenomar_CCode.get(CFill) == "New"){
             ...
             System.out.print("Enter the code you want to view: ");
                                ...
                                if(Marriage_Code.containsKey(MFill)){
                                    ...
                                    if(CE.equals("Y")){
                                        ...
                                        if(Marriage_MCode.get(MFill) == "New"){
                                            ...
                                            System.out.println("This Data have been denied!!");
                                        }
                                        Another();
                                    }else if(CE.equals("N")){
                                        Another();
